...
function WavesCanvas({ colors }) {
  ...
  useEffect(() => {
    ...
    const draw = () => {
      ...
      g.addColorStop(0, "#0A0E1F"); g.addColorStop(1, rgba(deep, 1));
      ctx.fillStyle = g; ctx.fillRect(0, 0, STAGE_W, STAGE_H);
      for (let k = 0; k < 3; k++) {
...
export function Background({ bg, mode = "live" }) {
  ...
  if (mode === "thumb") {
    ...
    const map = {
      ...
      starfield: `radial-gradient(circle at 50% 90%, ${c0}33, #070A16 70%)`,
      ...
      waves: `linear-gradient(180deg, #0A0E1F 20%, ${c0}44 55%, ${P.deep} 90%)`,
      rain: `linear-gradient(180deg, #070A16, ${c0}26)`,
      circuit: `radial-gradient(circle at 30% 40%, ${c0}2a, #080C1C 75%)`,
      map: `radial-gradient(circle at 48% 42%, ${c0}30, #090D20 72%)`,
  ...
  if (type === "beams") {
    ...
    return (
      <div style={{ ...fill, background: `linear-gradient(160deg, #0A0E1F, ${P.deep})` }}>
        <div style={{
  ...
  if (type === "bokeh") {
    ...
    return (
      <div style={{ ...fill, background: `linear-gradient(180deg, #0D1328, ${P.deep})` }}>
  ...
  if (type === "grid") {
    ...
    return (
      <div style={{ ...fill, background: `linear-gradient(180deg, ${P.deep}, #101730)` }}>
        <div style={{
