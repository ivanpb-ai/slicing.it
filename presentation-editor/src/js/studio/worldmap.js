...
export function makeMapRenderer(P) {
  ...
  return function drawMap(ctx, t, colors, locations) {
    ...
    g.addColorStop(0, "#090D20"); g.addColorStop(1, "#161F3B");
    ...
    for (var m = 0; m < locs.length; m++) {
      ...
      if (locs[m].label) {
        ...
        ctx.fillStyle = active ? "rgba(236,239,255,0.95)" : "rgba(236,239,255,0.55)";
    ...
    vg.addColorStop(0, "rgba(0,0,0,0)"); vg.addColorStop(1, "rgba(5,8,17,0.55)");
