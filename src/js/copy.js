...
export const COPY = {
  ui: {
    ...
    roadmapMilestones: "NorthStar milestones"
  },
  navLabels: [
    "",
    "Inflection",
  ...
  hero: {
    ...
    subtitle: [
      "When 5G Standalone stops being ",
      {
        t: "a network",
        c: P.cyan
      },
    ...
    stats: [
      {
        ...
        suf: "T",
        dec: 1,
        label: "Global 5G value pool by 2035"
      },
      {
        v: 25,
        pre: "",
  ...
  inflection: {
    ...
    headline: [
      ...
      {
        t: "And everything is about to change.",
        c: P.dim,
        size: "0.55em"
      }
    ],
    ...
    note: [
      "Every prior generation gave us ",
      {
        t: "more bandwidth",
        c: P.dim,
        b: true
  ...
  waves: {
    ...
    bands: [
      ...
      {
        tag: "Wave 2 · 2027–2030",
        title: "Cognitive",
        icon: "🧠",
        color: P.magenta,
        summary: "Network as intelligence. AI inside the RAN, the core, the orchestration loop — predicting, healing, optimizing in real time.",
        bullets: [
    ...
    points: [
      {
        color: P.cyan,
        title: "Proactive SLA",
        desc: "Predict slice degradation 30+ seconds before users feel it; reschedule resources first."
      },
      {
        color: P.magenta,
        title: "Intent-Based Slicing",
        desc: "Describe outcomes (\"sub-10ms for 200 robots\") — the orchestrator designs and deploys the slice."
      },
      {
        color: P.gold,
        title: "Energy as a Metric",
        desc: "AI tunes radio power, beam selection and sleep cycles for >40% lower energy per Gbit."
      },
      {
        color: P.green,
        title: "Digital Twin Ops",
        desc: "Run what-if scenarios against a live, continuously-trained twin before touching production."
      }
    ],
    note: [
      {
  ...
  ambient: {
    ...
    uses: [
      {
        icon: "🛸",
        title: "Drone airspace mapping",
        desc: "Track tens of thousands of UAVs in real time for low-altitude traffic management."
      },
      {
        icon: "🌧️",
        title: "Weather & atmospheric sensing",
        desc: "Detect rain cells, fog and pollution at street resolution — for cities, ports and farming."
      },
      {
        icon: "🚷",
        title: "Privacy-respecting presence",
        desc: "Count and track without cameras: factories, hospitals, transport hubs."
      },
      {
        icon: "🛡️",
        title: "Defence-grade situational awareness",
        desc: "Sovereign sensing slice for armed forces & critical infrastructure."
      },
      {
        icon: "💸",
        title: "Sensing-as-a-Service",
        desc: "A new revenue stream measured in queries-per-day, not Gbits."
      }
    ]
  },
  positioning: {
    ...
    ladder: [
      {
        era: "5G SA · 2026–2027",
        acc: "~1–2 m",
        detail: "Indoor — dot positioning · RTK over 5G SA",
        color: P.cyan
      },
      {
        era: "5G SA · 2026–2027",
        acc: "<50 m",
        detail: "Outdoor — Timing Advance + Angle-of-Arrival · GPS-level alternative / fallback",
        color: P.cyan
      },
      {
        era: "2028–2030",
        acc: "<1 m",
        detail: "AI fusion · ISAC · macro",
        color: P.magenta
      },
      {
        era: "2030+",
        acc: "<10 cm",
        detail: "Cross-tech · 6G upper mid",
        color: P.green
      }
    ],
    ...
    examples: [
      {
        icon: "⛏️",
        what: "Underground tracking of workers and machines far below the surface."
      },
      {
        icon: "🦽",
        what: "Locate medical assets in hospitals to the room — without GPS."
      },
      {
        icon: "🚛",
        what: "Lane-level vehicle positioning for autonomous corridors."
      }
    ]
  },
  ntn: {
    ...
    items: [
      {
        y: "Now",
        title: "Satellite as backhaul",
        desc: "NorthStar explores LEO/MEO backhaul for nomadic & rural cells.",
        c: P.cyan
      },
      {
        y: "2027",
        title: "NR-NTN normative",
        desc: "First handover-capable satellite 5G NR; IoT-NTN store-and-forward.",
        c: P.magenta
      },
      {
        y: "2029–30",
        title: "Direct-to-device handsets",
        desc: "Consumer phones speaking 5G to LEO sats — seamless terrestrial fallback.",
        c: P.gold
      },
      {
        y: "2031+",
        title: "Regenerative payloads & 6G NTN",
    ...
    cards: [
      {
        icon: "⛏️",
        year: "2030",
        title: "Mining without humans underground",
        color: P.cyan,
      ...
      },
      {
        icon: "🚑",
        year: "2028",
        title: "The ambulance becomes the hospital",
        color: P.red,
      ...
      },
      {
        icon: "🛡️",
        year: "2030",
        title: "Sovereign mission-critical",
        color: P.purple,
      ...
      },
      {
        icon: "⚡",
        year: "2032",
        title: "Smart grids that self-balance",
        color: P.magenta,
      ...
      },
      {
        icon: "🌾",
        year: "2030",
        title: "Precision agriculture at field scale",
        color: P.electric,
      ...
      },
      {
        icon: "🛰️",
        year: "2031",
        title: "Maritime, polar, aeronautical",
        color: P.green,
  ...
  economy: {
    ...
    legend: [
      {
        color: P.faint,
        label: "Connectivity (commoditising)"
      },
      {
        color: P.cyan,
        label: "Slices"
  ...
  roadmap: {
    ...
    data: {
      "2025": {
        qos: [
          "Basic slice/DNN/5QI service modelling"
        ],
        apis: [
          "Telia API Gateway integration",
          "CAMARA Quality-on-Demand API",
          "CAMARA Positioning & tracking API"
        ],
        location: [
          "Indoor dot positioning ~1–2 m",
          "GNSS RTK over 5G SA — cm-level precision"
        ],
        edge: [
          "Local & city-wide breakout deployment"
        ],
        iot: [
          "RedCap for higher throughput at lower battery"
        ],
        uplink: [
          "UL CA + UL SU-MIMO (3tx)"
        ],
        v2x: [
          "V2X slice using 5QI 79"
        ],
        latency: [
          "Introduction of L4S for stable low-latency streams"
        ],
        other: [
          "SIB9 for 5G time sync"
        ]
      },
      "2026": {
        qos: [
          "Advanced Slice/DNN/5QI service modelling"
        ],
        apis: [
          "Geofencing CAMARA via ENL"
        ],
        location: [
          "AI model for indoor positioning",
          "Outdoor positioning TA & AoA (~10–50 m)",
          "Passive 5G SA outdoor positioning"
        ],
        edge: [
          "AI compute edge node integration",
          "More multi-tenant edge breakout nodes"
        ],
        iot: [
          "DRX/eDRX power saving for RedCap"
        ],
        uplink: [
          "Uplink configured grant"
        ],
        v2x: [
          "Connected digital traffic signage",
          "Additional 5QIs for V2X"
        ],
        latency: [
          "L4S E2E usage by first NorthStar partners"
        ],
        other: [
          "ISAC/Sensing testing at Future by Lund",
          "Satellite as backhaul exploration"
        ]
      },
      "2027": {
        qos: [
          "New templates for 5GAA & 5G-ACIA",
          "URSP for Windows/iOS/Android"
        ],
        apis: [
          "Seamless authentication via CAMARA + SES",
          "Connectivity insights via CAMARA"
        ],
        location: [
          "Improved indoor positioning through AI",
          "Macro positioning tuned & more precise"
        ],
        edge: [
          "Rollout of distributed AI+Edge nodes",
          "Scaling edge breakout to 40+ city nodes"
        ],
        iot: [
          "eRedCap for ultra-optimised battery"
        ],
        uplink: [
          "Local mmWave (regulator dependent)"
        ],
        v2x: [
          "Edge discovery / handover for vehicles"
        ],
        latency: [
          "L4S rollout to several partners",
          "uRLLC enhancements (RAN)"
        ],
        other: [
          "Early sensing + tracking ISAC scenarios",
          "Satellite as backhaul deployment",
          "Nomadic cells for underserved areas"
        ]
      },
      "2028": {
        qos: [
          "Intent-based slice creation incl. QoS"
        ],
        apis: [
        ...
        location: [
          "High-accuracy cross-tech positioning (macro ↔ indoor ↔ RTK)",
          "Improved positioning using ISAC"
        ],
        edge: [
          "Edge breakout scaling to 100+ city nodes"
        ],
        iot: [
          "RedCap and eRedCap device proliferation"
        ],
        uplink: [
          "Expanded mmWave (regulator dependent)"
        ],
        v2x: [
          "Remote control of vehicles in public-road trials"
        ],
        latency: [
          "TSN for manufacturing & smart grids (5G LAN)",
          "Latency-prioritised scheduling for TSN"
        ],
        other: [
          "ISAC deployed for public sector & defence",
          "NR-NTN & IoT-NTN early deployment"
        ]
      },
      "2029": {
        qos: [
          "AI-based slice creation incl. QoS"
        ],
        apis: [
          "Support for 20+ CAMARA APIs"
        ],
        location: [
          "Mature positioning using ISAC",
          "Leaking-cable positioning exploration"
        ],
        edge: [
          "Full NorthStar integration across AI + Edge + RAN"
        ],
        iot: [],
        uplink: [],
        v2x: [
          "Autonomous-vehicle corridor tests"
        ],
        latency: [
          "Mature TSN ecosystem"
        ],
        other: [
          "Mature ISAC ecosystem",
          "Vertical 5G for aeronautics",
          "Full 5G/Satellite integration"
        ]
      }
    }
  },
    ...
    items: [
      {
        ...
        bullets: [
          ...
          "NTN Phase 2",
          "XR support",
          "MBS efficient delivery"
        ]
      },
      {
        rel: "Rel-19",
        period: "2025–26",
        label: "5G-Adv. Phase 2",
        color: P.magenta,
        bullets: [
          "AI/ML on the air interface",
          "NTN Phase 3",
      ...
      },
      {
        ...
        color: P.gold,
        bullets: [
          "6G study items kick off",
          "NTN/terrestrial convergence",
          "Sub-THz exploration",
          "FR3 (7–24 GHz)"
        ]
      },
  ...
  vision: {
    kicker: "2036",
    headline: [
      "The network won't be",
      {
        br: true
      },
      {
        t: "something you connect to.",
        c: P.dim
      },
      {
        br: true
      ...
      {
        t: "It will be everywhere you are.",
        grad: [
          P.cyan,
          P.light,
          P.magenta,
    ...
    ctas: [
      ...
      {
        label: "Open the simulations",
        href: "unified-5g-viz.html"
      },
      {
        label: "Talk to us",
        href: "mailto:northstar@teliacompany.com?subject=NorthStar%20Future%20Vision"
      }
    ]
  }
};
