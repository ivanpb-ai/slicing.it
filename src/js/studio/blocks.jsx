...
function Frame({ el, active, mode, children }) {
  ...
  return (
    <div style={outer} data-elid={el.id}>
...
function Kicker({ el }) {
  const s = el.style;
  return (
    <div style={{ width: "100%", height: "100%", display: "flex", alignItems: "center", justifyContent: justify(s.align), textAlign: s.align, color: s.color, fontFamily: s.fontFamily || FONTS.mono, fontSize: s.fontSize, letterSpacing: s.letterSpacing, fontStyle: s.italic ? "italic" : "normal", textTransform: "uppercase" }}>
      {el.props.text}
    </div>
  );
}
...
function Quote({ el }) {
  ...
  return (
    <div style={{ width: "100%", height: "100%", display: "flex", flexDirection: "column", justifyContent: "center", textAlign: s.align }}>
      ...
      <div style={{ color: s.color, fontFamily: s.fontFamily || FONTS.head, fontWeight: 300, fontSize: s.fontSize, lineHeight: 1.25, fontStyle: s.italic ? "italic" : "normal" }}>{el.props.text}</div>
...
function Counter({ el, mode, active }) {
  ...
  return (
    <div style={{ width: "100%", height: "100%", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", textAlign: "center" }}>
      <div style={{ fontFamily: s.fontFamily || FONTS.head, fontWeight: 300, fontSize: s.fontSize, color: s.color, letterSpacing: -1, lineHeight: 1, fontStyle: s.italic ? "italic" : "normal" }}>
...
function List({ el }) {
  const s = el.style;
  return (
    <div style={{ width: "100%", height: "100%", display: "flex", flexDirection: "column", justifyContent: "center", gap: s.gap, color: s.color, fontFamily: s.fontFamily || FONTS.body, fontSize: s.fontSize, lineHeight: 1.45, fontStyle: s.italic ? "italic" : "normal" }}>
...
function Card({ el }) {
  ...
  return (
    <div style={{ width: "100%", height: "100%", boxSizing: "border-box", background: `linear-gradient(180deg, ${c}1c, ${c}05)`, border: `1px solid ${c}45`, borderRadius: 18, padding: "22px 20px", position: "relative", overflow: "hidden", display: "flex", flexDirection: "column" }}>
      ...
      <div data-edit="title" style={{ fontFamily: el.style.fontFamily || FONTS.head, fontWeight: 300, fontSize: 30, color: el.style.color || P.white, marginBottom: 10, letterSpacing: -0.5, fontStyle: el.style.italic ? "italic" : "normal" }}>{p.title}</div>
      {p.body ? <div data-edit="body" style={{ fontSize: 13.5, color: P.dim, lineHeight: 1.6, marginBottom: 12 }}>{p.body}</div> : null}
