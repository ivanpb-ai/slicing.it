        ...
        <Dropdown wrapClass="st-decks" menuClass="st-decks-menu" label="▤ Decks ▾" render={(close) => (
          <>
            ...
            <div className="st-decks-foot">
              ...
              <button className="st-btn sm" title="Import a PowerPoint .pptx (converted to editable slides), a Studio .json, or converted .html slide pages" onClick={() => { onImport(); close(); }}>Import…</button>
            </div>
            {onPublishTemplate && (
              <div className="st-decks-foot">
